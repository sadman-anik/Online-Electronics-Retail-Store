...
![Recover account email page](recover-account-email.png)

Email recovery form used to request a password recovery code.

![Recover account reset page](recover-account-reset.png)

Recovery code and password reset page.

## Create Tablet

![Create tablet page](create-tablet.png)
...
![Add customer page](add-customer.png)

Customer creation form for name, address, and email details.

## Customer List

![Customer list page](list-customer.png)
